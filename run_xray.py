...
def main():
    ...
    # Check if either CCP4 or Phenix setup shell script is provided
    assert args.ccp4_setup_sh is not None and args.phenix_setup_sh is not None, "CCP4 and Phenix setup shell script must be provided"
