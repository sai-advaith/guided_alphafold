...
def main():
    ...
    guided_config_file_path = preprocess_inputs(args.pdb_id.lower(), args.chain_id, args.sub_seq, args.input_directory, args.output_directory,  args.ccp4_setup_sh, args.phenix_setup_sh, args.wandb_key, args.wandb_project, args.map_type)
