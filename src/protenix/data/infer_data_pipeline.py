...
def get_inference_dataloader(configs: Any, msa_configuration=None) -> DataLoader:
    """
    ...
    dataloader = DataLoader(
        ...
        num_workers= 0 if torch.backends.mps.is_available() else configs.num_workers,
    )
    return dataloader
